...
# a python sscript that removes genotypes from .vcf files with exceedingly high read coverage as measured on a per-sample basis (indicative of paralogy/nonsense mapping)
